package com.smarticle.gladvanced;

import javax.microedition.khronos.opengles.GL10;

import com.smarticle.framework.Game;
import com.smarticle.framework.Screen;
import com.smarticle.framework.gl.Camera2D;
import com.smarticle.framework.gl.EulerCamera;
import com.smarticle.framework.gl.PointLight;
import com.smarticle.framework.gl.SpriteBatcher;
import com.smarticle.framework.gl.Texture;
import com.smarticle.framework.gl.TextureRegion;
import com.smarticle.framework.gl.Vertices3;
import com.smarticle.framework.impl.GLGame;
import com.smarticle.framework.impl.GLScreen;
import com.smarticle.framework.math.Vector2;
import com.smarticle.framework.math.Vector3;
...
public class EulerCameraTest extends GLGame {
	...
	class EulerCameraScreen extends GLScreen {
		...
		private Vertices3 createCube() {
			float[] vertices = { -0.5f, -0.5f, 0.5f, 0, 1, 0, 0, 1, 0.5f,
					-0.5f, 0.5f, 1, 1, 0, 0, 1, 0.5f, 0.5f, 0.5f, 1, 0, 0, 0,
					1, -0.5f, 0.5f, 0.5f, 0, 0, 0, 0, 1,
					...
					1, 0, 0, -1, -0.5f, 0.5f, -0.5f, 1, 0, 0, 0, -1, 0.5f,
					0.5f, -0.5f, 0, 0, 0, 0, -1,

					-0.5f, -0.5f, -0.5f, 0, 1, -1, 0, 0, -0.5f, -0.5f, 0.5f, 1,
					1, -1, 0, 0, -0.5f, 0.5f, 0.5f, 1, 0, -1, 0, 0, -0.5f,
					0.5f, -0.5f, 0, 0, -1, 0, 0,

					-0.5f, 0.5f, 0.5f, 0, 1, 0, 1, 0, 0.5f, 0.5f, 0.5f, 1, 1,
					0, 1, 0, 0.5f, 0.5f, -0.5f, 1, 0, 0, 1, 0, -0.5f, 0.5f,
					-0.5f, 0, 0, 0, 1, 0,

					-0.5f, -0.5f, -0.5f, 0, 1, 0, -1, 0, 0.5f, -0.5f, -0.5f, 1,
					1, 0, -1, 0, 0.5f, -0.5f, 0.5f, 1, 0, 0, -1, 0, -0.5f,
					-0.5f, 0.5f, 0, 0, 0, -1, 0 };
			short[] indices = { 0, 1, 2, 2, 3, 0, 4, 5, 6, 6, 7, 4, 8, 9, 10,
